    ...
    countdownInterval = setInterval(() => {
        if (totalSeconds <= 0) {
            ...
            if (soundEnabled) {
                ...
                playAlarmSound();
                document.getElementById("stopButton").onclick = stopAlarmBox4;
            }
        } else {
    ...
    intervalId = setInterval(() => {
        if (cycleCount < newJapaMalaValue) {
            ...
            if (soundEnabled) {
                ...
                document.getElementById("stopButton1").onclick = stopAlarmBox5;
...
function japaKara() {
    ...
    japaCountDisplay.style.backgroundColor = "#ffffff"; // White background
    japaCountDisplay.style.border = "2px solid " + getRandomColor();
    ...
    cycleCountDisplay.style.backgroundColor = "#ffffff"; // White background
    cycleCountDisplay.style.border = "2px solid " + getRandomColor();
...
function resetAction() {
    ...
    stopTimer();
    document.getElementById("timerDisplay1").textContent = '00:00:00';
    timerRunning = false;
